...
class RiderAcceptOrderScreen extends StatefulWidget {
  const RiderAcceptOrderScreen({super.key});

  @override
  State<RiderAcceptOrderScreen> createState() => _RiderAcceptOrderScreenState();
}

class _RiderAcceptOrderScreenState extends State<RiderAcceptOrderScreen> {
  @override
