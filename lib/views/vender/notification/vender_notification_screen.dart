...
class VenderNotificationScreen extends StatefulWidget {
  const VenderNotificationScreen({super.key});

  @override
  State<VenderNotificationScreen> createState() =>
      _VenderNotificationScreenState();
}

class _VenderNotificationScreenState extends State<VenderNotificationScreen> {
