...
class VenderProfileScreen extends StatefulWidget {
  const VenderProfileScreen({super.key});

  @override
  State<VenderProfileScreen> createState() => _VenderProfileScreenState();
}

class _VenderProfileScreenState extends State<VenderProfileScreen> {
  @override
                ...
                children: [
                  ArrowCards(
                    ontap: () {
                      ...
                      Navigator.pushNamed(context, vender_myfood_route);
                    },
                    settingname: "My Foods",
